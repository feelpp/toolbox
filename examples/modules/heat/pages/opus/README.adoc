...
++++
<div id="plotly_test1a"></div>
<script type="text/javascript">
  Plotly.d3.csv("https://girder.math.unistra.fr/api/v1/file/5afea86fb0e957402704804a/download",
    function(err,rows) {
      var data = [{
        name: 'IC2 reference results of test 1a',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Ref-test1a-s1'),
        showlegend: true,
        line: { color: '#FF99BB' }
      },{
        ...
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Results-test1a-s1'),
        showlegend: true,
        line: { color: '#CC3333' }
      },{
        ...
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Ref-test1a-s2'),
        showlegend: true,
        line: { color: '#BB99FF' }
      },{
        ...
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Results-test1a-s2'),
        showlegend: true,
        line: { color: '#3333CC' }
      }];
      ...
      Plotly.plot(plotly_test1a,data,layout,{ showLink: false });

      feelpp_add_redimensionable_plot(plotly_test1a);
    }
  );
</script>
++++
...
link:{uri-data}/2Dbuilding/[Github] here :
...
++++
<button class="btn" data-clipboard-target="#command-line-test1a">
Copy command line to clipboard
</button>
<button class="btn" data-clipboard-text="github:{repo:toolbox,path:examples/modules/heat/examples/opus}">
...
++++
<div id="plotly_test1b"></div>
<script type="text/javascript">
  Plotly.d3.csv("https://girder.math.unistra.fr/api/v1/file/5afea86fb0e957402704804a/download",
    function(err,rows) {
      var data = [{
        name: 'IC2 reference results of test 1b',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Ref-test1b-s1'),
        showlegend: true,
        line: { color: '#FF99BB' }
      },{
        name: 'IC2 example results of test 1b',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Results-test1b-s1'),
        showlegend: true,
        line: { color: '#CC3333' }
      },{
        name: 'Output reference results of test 1b',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Ref-test1b-s2'),
        showlegend: true,
        line: { color: '#BB99FF' }
      },{
        name: 'Output example results of test 1b',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Results-test1b-s2'),
        showlegend: true,
        line: { color: '#3333CC' }
      }];
      ...
      feelpp_add_redimensionable_plot(plotly_test1b);
    }
  );
</script>
++++
...
[source,cfg]
----
include::{examplesdir}/opus/test1b.cfg[]
----
...
++++
<button class="btn" data-clipboard-target="#command-line-test1b">
Copy command line to clipboard
</button>
<button class="btn" data-clipboard-text="github:{repo:toolbox,path:examples/modules/heat/examples/opus}">
Copy case option to clipboard
...
++++
<div id="plotly_test1c"></div>
<script type="text/javascript">
  Plotly.d3.csv("https://girder.math.unistra.fr/api/v1/file/5afea86fb0e957402704804a/download",
    function(err,rows) {
      var data = [{
        name: 'IC2 reference results of test 1c',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Ref-test1c-s1'),
        showlegend: true,
        line: { color: '#FF99BB' }
      },{
        name: 'IC2 example results of test 1c',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Results-test1c-s1'),
        showlegend: true,
        line: { color: '#CC3333' }
      },{
        name: 'Output reference results of test 1c',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Ref-test1c-s2'),
        showlegend: true,
        line: { color: '#BB99FF' }
      },{
        name: 'Output example results of test 1c',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Results-test1c-s2'),
        showlegend: true,
        line: { color: '#3333CC' }
      }];
      ...
      Plotly.plot(plotly_test1c,data,layout,{ showLink: false });

      feelpp_add_redimensionable_plot(plotly_test1c);
    }
  );
</script>
++++
...
[source,cfg]
----
include::{examplesdir}/opus/test1c.cfg[]
----
...
++++
<button class="btn" data-clipboard-target="#command-line-test1c">
Copy command line to clipboard
</button>
<button class="btn" data-clipboard-text="github:{repo:toolbox,path:examples/modules/heat/examples/opus}">
Copy case option to clipboard
...
++++
<div id="plotly_test1d"></div>
<script type="text/javascript">
  Plotly.d3.csv("https://girder.math.unistra.fr/api/v1/file/5afea86fb0e957402704804a/download",
    function(err,rows) {
      var data = [{
        name: 'IC2 reference results of test 1d',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Ref-test1d-s1'),
        showlegend: true,
        line: { color: '#FF99BB' }
      },{
        name: 'IC2 example results of test 1d',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Results-test1d-s1'),
        showlegend: true,
        line: { color: '#CC3333' }
      },{
        name: 'Output reference results of test 1d',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Ref-test1d-s2'),
        showlegend: true,
        line: { color: '#BB99FF' }
      },{
        name: 'Output example results of test 1d',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Results-test1d-s2'),
        showlegend: true,
        line: { color: '#3333CC' }
      }];
      ...
      Plotly.plot(plotly_test1d,data,layout,{ showLink: false });

      feelpp_add_redimensionable_plot(plotly_test1d);
    }
  );
</script>
++++
...
[source,cfg]
----
include::{examplesdir}/opus/test1d.cfg[]
----
...
++++
<button class="btn" data-clipboard-target="#command-line-test1d">
Copy command line to clipboard
</button>
<button class="btn" data-clipboard-text="github:{repo:toolbox,path:examples/modules/heat/examples/opus}">
Copy case option to clipboard
...
++++
<div id="plotly_test1e"></div>
<script type="text/javascript">
  Plotly.d3.csv("https://girder.math.unistra.fr/api/v1/file/5afea86fb0e957402704804a/download",
    function(err,rows) {
      var data = [{
        name: 'IC2 reference results of test 1e',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Ref-test1e-s1'),
        showlegend: true,
        line: { color: '#FF99BB' }
      },{
        name: 'IC2 example results of test 1e',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Results-test1e-s1'),
        showlegend: true,
        line: { color: '#CC3333' }
      },{
        name: 'Output reference results of test 1e',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Ref-test1e-s2'),
        showlegend: true,
        line: { color: '#BB99FF' }
      },{
        name: 'Output example results of test 1e',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Results-test1e-s2'),
        showlegend: true,
        line: { color: '#3333CC' }
      }];
      ...
      Plotly.plot(plotly_test1e,data,layout,{ showLink: false });

      feelpp_add_redimensionable_plot(plotly_test1e);
    }
  );
</script>
++++
...
[source,cfg]
----
include::{examplesdir}/opus/test1e.cfg[]
----
...
++++
<button class="btn" data-clipboard-target="#command-line-test1e">
Copy command line to clipboard
</button>
<button class="btn" data-clipboard-text="github:{repo:toolbox,path:examples/modules/heat/examples/opus}">
Copy case option to clipboard
...
++++
<div id="plotly_test1f"></div>
<script type="text/javascript">
  Plotly.d3.csv("https://girder.math.unistra.fr/api/v1/file/5afea86fb0e957402704804a/download",
    function(err,rows) {
      var data = [{
        name: 'IC2 reference results of test 1f',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Ref-test1f-s1'),
        showlegend: true,
        line: { color: '#FF99BB' }
      },{
        name: 'IC2 example results of test 1f',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Results-test1f-s1'),
        showlegend: true,
        line: { color: '#CC3333' }
      },{
        name: 'Output reference results of test 1f',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Ref-test1f-s2'),
        showlegend: true,
        line: { color: '#BB99FF' }
      },{
        name: 'Output example results of test 1f',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Results-test1f-s2'),
        showlegend: true,
        line: { color: '#3333CC' }
      }];
      ...
      Plotly.plot(plotly_test1f,data,layout,{ showLink: false });

      feelpp_add_redimensionable_plot(plotly_test1f);
    }
  );
</script>
++++
...
[source,cfg]
----
include::{examplesdir}/opus/test1f.cfg[]
----
...
++++
<button class="btn" data-clipboard-target="#command-line-test1f">
Copy command line to clipboard
</button>
<button class="btn" data-clipboard-text="github:{repo:toolbox,path:examples/modules/heat/examples/opus}">
Copy case option to clipboard
...
The _.json_ file differs in this case :

// highlight javascript better
[source,json] 
----
include::{examplesdir}/opus/eads_stationary.json[]
----

// highlight ini better
[source,cfg]
----
include::{examplesdir}/opus/test1g.cfg[]
----
...
++++
<button class="btn" data-clipboard-target="#command-line-test1g">
Copy command line to clipboard
</button>
<button class="btn" data-clipboard-text="github:{repo:toolbox,path:examples/modules/heat/examples/opus}">
Copy case option to clipboard
...
++++
<div id="plotly_test3"></div>
<script type="text/javascript">
  Plotly.d3.csv("https://girder.math.unistra.fr/api/v1/file/5afea86fb0e957402704804a/download",
    function(err,rows) {
      var data = [{
        name: 'IC2 reference results of test 3',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Ref-test3-s1'),
        showlegend: true,
        line: { color: '#FF99BB' }
      },{
        name: 'IC2 example results of test 3',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Results-test3-s1'),
        showlegend: true,
        line: { color: '#CC3333' }
      },{
        name: 'Output reference results of test 3',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Ref-test3-s2'),
        showlegend: true,
        line: { color: '#BB99FF' }
      },{
        name: 'Output example results of test 3',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Results-test3-s2'),
        showlegend: true,
        line: { color: '#3333CC' }
      }];
      ...
      Plotly.plot(plotly_test3,data,layout,{ showLink: false });

      feelpp_add_redimensionable_plot(plotly_test3);
    }
  );
</script>
++++
...
[source,cfg]
----
include::{examplesdir}/opus/test3.cfg[]
----
...
++++
<button class="btn" data-clipboard-target="#command-line-test3">
Copy command line to clipboard
</button>
<button class="btn" data-clipboard-text="github:{repo:toolbox,path:examples/modules/heat/examples/opus}">
Copy case option to clipboard
...
++++
<div id="plotly_test4"></div>
<script type="text/javascript">
  Plotly.d3.csv("https://girder.math.unistra.fr/api/v1/file/5afea86fb0e957402704804a/download",
    function(err,rows) {
      var data = [{
        name: 'IC2 reference results of test 4',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Ref-test4-s1'),
        showlegend: true,
        line: { color: '#FF99BB' }
      },{
        name: 'IC2 example results of test 4',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Results-test4-s1'),
        showlegend: true,
        line: { color: '#CC3333' }
      },{
        name: 'Output reference results of test 4',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Ref-test4-s2'),
        showlegend: true,
        line: { color: '#BB99FF' }
      },{
        name: 'Output example results of test 4',
        type: 'scatter',
        x: feelpp_unpack(rows,'T'),
        y: feelpp_unpack(rows,'Results-test4-s2'),
        showlegend: true,
        line: { color: '#3333CC' }
      }];
      ...
      Plotly.plot(plotly_test4,data,layout,{ showLink: false });

      feelpp_add_redimensionable_plot(plotly_test4);
    }
  );
</script>
++++
...
[source,cfg]
----
include::{examplesdir}/opus/test4.cfg[]
----
...
++++
<button class="btn" data-clipboard-target="#command-line-test4">
Copy command line to clipboard
</button>
<button class="btn" data-clipboard-text="github:{repo:toolbox,path:examples/modules/heat/examples/opus}">
Copy case option to clipboard

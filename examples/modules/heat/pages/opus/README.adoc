  ...
  Plotly.d3.csv("https://girder.math.unistra.fr/api/v1/file/5afea86fb0e957402704804a/download",
    function(err,rows) {
      var data = [{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Ref-test1a-s1'),
        showlegend: true,
        line: { color: '#FF99BB' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Results-test1a-s1'),
        showlegend: true,
        line: { color: '#CC3333' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Ref-test1a-s2'),
        showlegend: true,
        line: { color: '#BB99FF' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Results-test1a-s2'),
        showlegend: true,
        line: { color: '#3333CC' }
      }];
      ...
      plotly_add_redimensionable_plot(plotly_test1a);
    }
  );
</script>
++++
  ...
  Plotly.d3.csv("https://girder.math.unistra.fr/api/v1/file/5afea86fb0e957402704804a/download",
    function(err,rows) {
      var data = [{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Ref-test1b-s1'),
        showlegend: true,
        line: { color: '#FF99BB' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Results-test1b-s1'),
        showlegend: true,
        line: { color: '#CC3333' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Ref-test1b-s2'),
        showlegend: true,
        line: { color: '#BB99FF' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Results-test1b-s2'),
        showlegend: true,
        line: { color: '#3333CC' }
      }];
      ...
      plotly_add_redimensionable_plot(plotly_test1b);
    }
  );
</script>
++++
  ...
  Plotly.d3.csv("https://girder.math.unistra.fr/api/v1/file/5afea86fb0e957402704804a/download",
    function(err,rows) {
      var data = [{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Ref-test1c-s1'),
        showlegend: true,
        line: { color: '#FF99BB' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Results-test1c-s1'),
        showlegend: true,
        line: { color: '#CC3333' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Ref-test1c-s2'),
        showlegend: true,
        line: { color: '#BB99FF' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Results-test1c-s2'),
        showlegend: true,
        line: { color: '#3333CC' }
      }];
      ...
      plotly_add_redimensionable_plot(plotly_test1c);
    }
  );
</script>
++++
  ...
  Plotly.d3.csv("https://girder.math.unistra.fr/api/v1/file/5afea86fb0e957402704804a/download",
    function(err,rows) {
      var data = [{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Ref-test1d-s1'),
        showlegend: true,
        line: { color: '#FF99BB' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Results-test1d-s1'),
        showlegend: true,
        line: { color: '#CC3333' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Ref-test1d-s2'),
        showlegend: true,
        line: { color: '#BB99FF' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Results-test1d-s2'),
        showlegend: true,
        line: { color: '#3333CC' }
      }];
      ...
      plotly_add_redimensionable_plot(plotly_test1d);
    }
  );
</script>
++++
  ...
  Plotly.d3.csv("https://girder.math.unistra.fr/api/v1/file/5afea86fb0e957402704804a/download",
    function(err,rows) {
      var data = [{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Ref-test1e-s1'),
        showlegend: true,
        line: { color: '#FF99BB' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Results-test1e-s1'),
        showlegend: true,
        line: { color: '#CC3333' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Ref-test1e-s2'),
        showlegend: true,
        line: { color: '#BB99FF' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Results-test1e-s2'),
        showlegend: true,
        line: { color: '#3333CC' }
      }];
      ...
      plotly_add_redimensionable_plot(plotly_test1e);
    }
  );
</script>
++++
  ...
  Plotly.d3.csv("https://girder.math.unistra.fr/api/v1/file/5afea86fb0e957402704804a/download",
    function(err,rows) {
      var data = [{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Ref-test1f-s1'),
        showlegend: true,
        line: { color: '#FF99BB' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Results-test1f-s1'),
        showlegend: true,
        line: { color: '#CC3333' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Ref-test1f-s2'),
        showlegend: true,
        line: { color: '#BB99FF' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Results-test1f-s2'),
        showlegend: true,
        line: { color: '#3333CC' }
      }];
      ...
      plotly_add_redimensionable_plot(plotly_test1f);
    }
  );
</script>
++++
  ...
  Plotly.d3.csv("https://girder.math.unistra.fr/api/v1/file/5afea86fb0e957402704804a/download",
    function(err,rows) {
      var data = [{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Ref-test3-s1'),
        showlegend: true,
        line: { color: '#FF99BB' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Results-test3-s1'),
        showlegend: true,
        line: { color: '#CC3333' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Ref-test3-s2'),
        showlegend: true,
        line: { color: '#BB99FF' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Results-test3-s2'),
        showlegend: true,
        line: { color: '#3333CC' }
      }];
      ...
      plotly_add_redimensionable_plot(plotly_test3);
    }
  );
</script>
++++
  ...
  Plotly.d3.csv("https://girder.math.unistra.fr/api/v1/file/5afea86fb0e957402704804a/download",
    function(err,rows) {
      var data = [{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Ref-test4-s1'),
        showlegend: true,
        line: { color: '#FF99BB' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Results-test4-s1'),
        showlegend: true,
        line: { color: '#CC3333' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Ref-test4-s2'),
        showlegend: true,
        line: { color: '#BB99FF' }
      },{
        ...
        type: 'scatter',
        x: plotly_unpack(rows,'T'),
        y: plotly_unpack(rows,'Results-test4-s2'),
        showlegend: true,
        line: { color: '#3333CC' }
      }];
      ...
      plotly_add_redimensionable_plot(plotly_test4);
    }
  );
</script>
++++

...
In this example, we simulate the extension of a coil spring.
...
[source,sh]
----
mpirun -np 4 feelpp_toolbox_fluid --case "github:{repo:toolbox,path:examples/modules/csm/examples/spring}"
----
++++

...
[source,json]
----
include::{examplesdir}/pendulum/pendulum2D/pendulum2D.json[tags=materials]
----
...
[source,json]
----
include::{examplesdir}/pendulum/pendulum2D/pendulum2D.json[tags=parameters]
----


==  Boundary conditions

=== Vertex angle: Dirichlet 
...
----
include::{examplesdir}/pendulum/pendulum2D/pendulum2D.json[tags=boundaryconditions]
----

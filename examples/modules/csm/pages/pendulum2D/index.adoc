...
[source,sh]
----
mpirun -np 4 feelpp_toolbox_solid --case "github:{repo:toolbox,path:examples/modules/csm/examples/pendulum/pendulum3D}"
----
...
<button class="btn" data-clipboard-text="github:{repo:toolbox,path:examples/modules/csm/examples/pendulum/pendulum3D}">
Copy case 2D option to clipboard
</button>
++++
...
* link:{uri-data}/pendulum/pendulum3D/pendulum3D.cfg[CFG file] - [link:{uri-data-edit}/pendulum/pendulum3D/pendulum3D.cfg[Edit the file]]
* link:{uri-data}/pendulum/pendulum3D/pendulum3D.json[JSON file] - [link:{uri-data-edit}/pendulum/pendulum3D/pendulum3D.json[Edit the file]]
...
[source,json,,indent=0]
----
include::{examplesdir}/pendulum/pendulum3D/pendulum3D.json[tags=bc]
----
== Outputs

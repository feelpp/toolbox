...
image:{imagesprefix}sensor/image1.png[image,width=209,height=225]image:{imagesprefix}sensor/image2.png[e3.png,width=155,height=209]image:{imagesprefix}sensor/image3.png[e2.png,width=212,height=202]
...
image:{imagesprefix}sensor/image4.png[5.png,width=302,height=268]image:{imagesprefix}sensor/image5.png[6.png,width=302,height=279]
...
image:{imagesprefix}sensor/image6.png[Képernyőfelvétel (834).png,width=306,height=283]image:{imagesprefix}sensor/image7.png[7.png,width=287,height=283]

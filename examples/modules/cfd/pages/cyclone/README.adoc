...
In this example, we simulate water flowing in a Cyclone mesh using the Navier-Stokes equation.
...
The model used is a Navier-Stokes model. 
It is described in the CFD toolbox, see xref:toolboxes:cfd:index.adoc[Computational Fluid Dynamics]

...
== Benchmarks
=== xref:laminar_isothermal_backward_facing_step/README.adoc[Laminar, Isothermal Backward Facing Step]
[cols="1,3"]
|===
| image:laminar_isothermal_backward_facing_step/geometry.png[Geometry,100%] | Separation and reattachment along a backward facing step .
|===
...
[cols="1,3"]
|===
| image:spring/perspective_pressure_pa_velocity_m_per_s.png[SpringCFD, 100%] | We simulate a low Reynolds fluid flow in a coil spring shaped tube.
|===

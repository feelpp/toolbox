...
----
feelpp_toolbox_fluid --case "github:{owner:feelpp,repo:toolbox,branch:master,path:benchmarks/modules/cfd/examples/pipestokes}" 
----
...
----
feelpp_toolbox_fluid --case "github:{owner:feelpp,repo:toolbox,branch:master,path:benchmarks/modules/cfd/examples/pipestokes}"  --fluid.gmsh.geo-variables-list="height=3" --json-editions Parameters.height:3
----
* For the pressure

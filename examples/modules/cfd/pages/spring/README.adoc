...
[source,shell]
----
mpirun -np 8 feelpp_toolbox_fluid --case "github:{repo:toolbox,path:examples/modules/cfd/spring}"
----
++++
<button class="btn" data-clipboard-target="#command-line">
Copy command line to clipboard
</button>
<button class="btn" data-clipboard-text="github:{repo:toolbox,path:examples/modules/cfd/spring}">

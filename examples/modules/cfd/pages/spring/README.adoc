...
+
* link:{uri-toolbox}/cfd/spring/spring.json[JSON file]
* link:{uri-toolbox}/cfd/spring/spring.cfg[CFG file]
...
[source,shell]
----
mpirun -np 4 feelpp_toolbox_fluid --config-file springcfd.cfg
mpirun -np 4 feelpp_toolbox_fluid --case "github:{repo:toolbox,path:examples/modules/cfd/spring}"
----

In the context of MSO4SC, the com

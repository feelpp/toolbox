...
| stem:[\rho] | fluid density | stem:[1056] | stem:[kg/m^3] |
|===

== Reynolds number

Given the tube diameter stem:[D = 1 \times 10^{-3}m], the fluid's viscosity and density in the table above and the maximum inflow velocity (~0.7m/s), we can calculate the Reynolds number:

stem:[R_e = \frac{\rho UL}{\mu} = \frac{1056 \times 7 \times 10^{-4}}{(6 \times 10^{-3})} \approx 1 \times 10^2]. 

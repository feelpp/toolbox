...
.2D Model of inflatable box at t=5 sec.
++++
...
feelppVtkJs.createSceneImporter( vtkVisuSection2, {
                                 ...
                                 objects: { "Fluid5sec":[ { scene:"fluid.velocity", name:"Fluid velocity" }, { scene:"fluid.pressure", name:"Fluid pressure" }, { scene:"pid" } ],"Solid5sec":[ { scene:"solid.velocity", name:"Solid velocity" }, { scene:"solid.displacement", name:"Solid displacement"}, { scene:"pid" } ], "SolidGeom":[ { scene:"Solid Color"}{ scene:"pid" }], "FluidGeom":[ { scene:"Solid Color"}{ scene:"pid" }]}
                                         } );
</script>

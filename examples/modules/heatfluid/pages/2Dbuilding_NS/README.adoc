...
NOTE: The report of the execution of the command above is available xref:2Dbuilding_NS/heatfluid-information.adoc[here].
== Data files
...
|====
a| image:{imagesprefix}2Dbuilding_NS/geo.png[]
|====
...
|====
a| image:{imagesprefix}2Dbuilding_NS/graph1.png[]
|====
...
|====
a| image:{imagesprefix}2Dbuilding_NS/velocity.png[] a|image:{imagesprefix}2Dbuilding_NS/pressure.png[]
|====

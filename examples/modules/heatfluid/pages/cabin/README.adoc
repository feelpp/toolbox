...
== Data files
The case data files are available in Github link:{examplesdir}/cabin/[here]

For the 2D model :
* link:{examplesdir}/cabin/cabin2d.cfg[CFG file]
* link:{examplesdir}/cabin/cabin2d.json[JSON file]
* link:{examplesdir}/cabin/cabin2d.geo[GEO file]

For the 3D model :
* link:{examplesdir}/cabin/cabin3d.cfg[CFG file]
* link:{examplesdir}/cabin/cabin3d.json[JSON file]
* link:{examplesdir}/cabin/cabin3d.geo[GEO file]

...
link:{exampledir}/unitsquare.geo[]

link:{exampledir}/unitsquare.cfg[]

link:{exampledir}/unitsquare.json[]
...
[%header,format=csv]
|===
include::{examplesdir}/P0-cv.csv[]
|===

.P1 convergence analysis
[%header,format=csv]
|===
include::{examplesdir}/P1-cv.csv[]
|===

.P2 convergence analysis
[%header,format=csv]
|===
include::{examplesdir}/P2-cv.csv[]
|===

.P3 convergence analysis
[%header,format=csv]
|===
include::{examplesdir}/P3-cv.csv[]
|===
...
link:{exampledir}/unitsquare2.geo[]

link:{exampledir}/unitsquare2.cfg[]

link:{exampledir}/unitsquare2.json[]
...
[%header,format=csv]
|===
include::{examplesdir}/P0-cv2.csv[]
|===

.P1 convergence analysis
[%header,format=csv]
|===
include::{examplesdir}/P1-cv2.csv[]
|===

.P2 convergence analysis
[%header,format=csv]
|===
include::{examplesdir}/P2-cv2.csv[]
|===

.P3 convergence analysis
[%header,format=csv]
|===
include::{examplesdir}/P3-cv2.csv[]
|===

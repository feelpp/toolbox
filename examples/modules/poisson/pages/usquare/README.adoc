...
link:../../examples/usquare/chessboard/unitsquare.geo[]

link:../../examples/usquare/chessboard/unitsquare.cfg[]

link:../../examples/usquare/chessboard/unitsquare.json[]
...
[%header,format=csv]
|===
include::../../examples/usquare/chessboard/P0-cv.csv[]
|===

.P1 convergence analysis
[%header,format=csv]
|===
include::../../examples/usquare/chessboard/P1-cv.csv[]
|===

.P2 convergence analysis
[%header,format=csv]
|===
include::../../examples/usquare/chessboard/P2-cv.csv[]
|===

.P3 convergence analysis
[%header,format=csv]
|===
include::../../examples/usquare/chessboard/P3-cv.csv[]
|===
...
|====
a| image:../../examples/usquare/chessboard/pressuremap.png[] a| image:../../examples/usquare/chessboard/velocitymap.png[] a| image:../../examples/usquare/chessboard/fluxfield.png[]
|====
...
link:../../examples/usquare/shower/unitsquare2.geo[]

link:../../examples/usquare/shower/unitsquare2.cfg[]

link:../../examples/usquare/shower/unitsquare2.json[]
...
[%header,format=csv]
|===
include::../../examples/usquare/shower/P0-cv2.csv[]
|===

.P1 convergence analysis
[%header,format=csv]
|===
include::../../examples/usquare/shower/P1-cv2.csv[]
|===

.P2 convergence analysis
[%header,format=csv]
|===
include::../../examples/usquare/shower/P2-cv2.csv[]
|===

.P3 convergence analysis
[%header,format=csv]
|===
include::../../examples/usquare/shower/P3-cv2.csv[]
|===
...
|====
a| image:../../examples/usquare/shower/pressuremap2.png[] a| image:../../examples/usquare/shower/velocitymap2.png[] a| image:../../examples/usquare/shower/fluxfield2.png[]
|====
...
feelppVtkJs.createSceneImporter( vtkVisuSection1, {
                                 fileURL: "https://girder.math.unistra.fr/api/v1/file/5b1fc13eb0e9570499f66bd6/download",
                                 objects: { "pressure":[ { scene:"mixedpoisson.p_exact",name:"p" }, { scene:"mixedpoisson.potential",name:"p_h" } ], "flux:[ { scene:"mixedpoisson.u_exact",name:"u"}, { scene:"mixedpoisson.flux",name:"u_h"} ] }
                                 } );
</script>

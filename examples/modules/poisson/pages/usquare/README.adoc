...
>>>>>>> f687534679eda4bf4fc4e0200b3c555ff3aa619a
...
link:../../examples/usquare/unitsquare.geo[]

link:../../examples/usquare/unitsquare.cfg[]

link:../../examples/usquare/unitsquare.json[]
...
[%header,format=csv]
|===
include::../../examples/usquare/P0-cv.csv[]
|===

.P1 convergence analysis
[%header,format=csv]
|===
include::../../examples/usquare/P1-cv.csv[]
|===

.P2 convergence analysis
[%header,format=csv]
|===
include::../../examples/usquare/P2-cv.csv[]
|===

.P3 convergence analysis
[%header,format=csv]
|===
include::../../examples/usquare/P3-cv.csv[]
|===
...
link:../../examples/usquare/unitsquare2.geo[]

link:../../examples/usquare/unitsquare2.cfg[]

link:../../examples/usquare/unitsquare2.json[]
...
[%header,format=csv]
|===
include::../../examples/usquare/P0-cv2.csv[]
|===

.P1 convergence analysis
[%header,format=csv]
|===
include::../../examples/usquare/P1-cv2.csv[]
|===

.P2 convergence analysis
[%header,format=csv]
|===
include::../../examples/usquare/P2-cv2.csv[]
|===

.P3 convergence analysis
[%header,format=csv]
|===
include::../../examples/usquare/P3-cv2.csv[]
|===

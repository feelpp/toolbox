...
link:{examplesdir}/usquare/unitsquare.geo[]

link:{examplesdir}/usquare/unitsquare.cfg[]

link:{examplesdir}/usquare/unitsquare.json[]
...
|====
a| image:{examplesdir}/usquare/pressuremap.png[] a| image:{examplesdir}/usquare/velocitymap.png[] a| image:{examplesdir}/usquare/fluxfield.png[]
|====
...
link:{examplesdir}/usquare/unitsquare2.geo[]

link:{examplesdir}/usquare/unitsquare2.cfg[]

link:{examplesdir}/usquare/unitsquare2.json[]
...
|====
a| image:{examplesdir}/usquare/pressuremap2.png[] a| image:{examplesdir}/usquare/velocitymap2.png[] a| image:{examplesdir}/usquare/fluxfield2.png[]
|====

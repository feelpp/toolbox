...
[source,json]
----
include::{examplesdir}/red/red.json[tags=materials]
----
...
=== Data file
link:{uri-toolbox}/examples/modules/poisson/examples/red[RED]::
Github directory with
+
* link:{uri-toolbox}/examples/modules/poisson/examples/red/red.json[JSON file]
* link:{uri-toolbox}/examples/modules/poisson/examples/red/red.cfg[CFG file]

=== Command line
To reproduce those results, one should run:
[source,shell]
----
mpirun -np 4 feelpp_toolbox_mixed-poisson-model_3DP1 --config-file red.cfg

...
link:{uri-toolbox}/examples/modules/poisson/examples/2Dchannel/channel.geo[GEO file]

link:{uri-toolbox}/examples/modules/poisson/examples/2Dchannel/channel.cfg[CFG file]

link:{uri-toolbox}/examples/modules/poisson/examples/2Dchannel/channel.json[JSON file]

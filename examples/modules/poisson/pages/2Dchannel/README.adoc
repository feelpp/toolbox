...
feelppVtkJs.createSceneImporter( vtkVisuSection1, {
                                 fileURL: "https://girder.math.unistra.fr/api/v1/file/5b30b7cfb0e9570499f671eb/download",
                                 objects: { "object":[ { scene:"mixedpoisson.flux",name:"velocity" }, { scene:"mixedpoisson.potential",name:"pressure" } ] }
                                 } );
</script>

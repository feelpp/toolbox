...
----
image:{examplesdir}/usquare/channel.png
----
...
feelppVtkJs.createSceneImporter( vtkVisuSection1, {
                                 fileURL: "https://girder.math.unistra.fr/api/v1/file/5b30aee8b0e9570499f671c6/download",
                                 objects: { "fields":[ { scene:"mixedpoisson.flux",name:"velocity" }, { scene:"mixedpoisson.potential",name:"pressure" }, {scene:"GlyphScale",name:"flux vector field" } ] }
                                 } );
</script>

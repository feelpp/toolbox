...
link:toolbox/examples/modules/poisson/examples/2Dchannel/channel.geo[GEO file]

link:toolbox/examples/modules/poisson/examples/2Dchannel/channel.cfg[CFG file]

link:toolbox/examples/modules/poisson/examples/2Dchannel/channel.json[JSON file]

...
image:images/media/image1.jpeg[232,190,float="left"]
...
image:images/media/image5.png[width=357,height=188]
image:images/media/image6.png[1.png,width=209,height=188]

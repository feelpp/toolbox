...
[[img-geometry1]]
image::{imagesdir}/TurekHron/TurekHronCSMGeometry.png[caption="Figure 1 : ", title="Geometry of the Turek & Hron CSM benchmark.", alt="CSM Geometry", width="500", align="center"]

...
[source,mpirun]
----
mpirun -np 4 feelpp_toolbox_electric --case "github:{path:toolboxes/electric/cases/quarter-turn}" --case.config-file 2d.cfg
----
...
[source,mpirun]
----
mpirun -np 4 feelpp_toolbox_electric --case "github:{path:toolboxes/electric/cases/quarter-turn}" --case.config-file 3d.cfg
----
...
- This problem is described by a steady electric conduction model for the potential stem:[V].
- **toolbox**:  electric

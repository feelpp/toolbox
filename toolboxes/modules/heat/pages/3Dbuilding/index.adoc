...
[source,json]
----
include::example$3Dbuilding/building.json[tags=materials]
----
...
[source,json]
----
include::example$3Dbuilding/building.json[tags=bc]
----
...
[source,json]
----
include::example$3Dbuilding/building.json[tags=postprocess]
----

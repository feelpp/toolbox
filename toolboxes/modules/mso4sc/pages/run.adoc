...
Go to the xref:toolboxes:ROOT:index.adoc[{feelpp} Toolboxes Manual] to discover examples and benchmarks for the different {feelpp} applications.
...
[source,java]
----
include::example$remotedesktop.txt[]
----

...
For a practical high-field resistive magnet model with temperature-dependent properties, see xref:../resistive-magnets-coupling.adoc[Coupled stem:[A-V-J-E-T] model for resistive magnets].

...
As in the xref:wavepressure2d/index.adoc[2D case], the blood flow modelisation, by observing a pressure wave progression into a vessel, is the subjet of this benchmark.
...
* We add the link:../index.adoc[coupling conditions] on stem:[\Gamma^*_{fsi}]

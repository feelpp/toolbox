...
:page-description: We simulate a pressure wave propagation into a three-dimensional elastic tube.
...
After solving the link:toolboxes:fsi:index.adoc[fluid struture model], we obtain stem:[(\mathcal{A}^t, \boldsymbol{u}_f, p_f, \boldsymbol{\eta}_s)]

...
stem:[\quad]We then pose a trilinear form stem:[a \colon \mathcal{H}_0^1(\Omega_F)^3 \times \mathcal{H}_0^1(\Omega_F)^3 \times  \to \mathcal{H}_0^1(\Omega_F)^3 \mathbb{R}] defined by:
...
and two bilinear forms stem:[b \colon \mathcal{H}_0^1(\Omega_F)^3 \times L^2_0(\Omega_F) \to \mathbb{R}] and stem:[d \colon \mathcal{H}^1(\Omega_F) \times \mathcal{H}_0^1(\Omega_F)^3 \times \to \mathbb{R}] defined by:
...
and a tri-linear form stem:[e \colon \mathcal{H}_0^1(\Omega_F)^3 \times \mathcal{H}^1(\Omega_F) \times \mathcal{H}^1(\Omega_F) \to \mathbb{R}] and a bilinear form stem:[f \colon \mathcal{H}^1(\Omega_F) \times \mathcal{H}^1(\Omega_F) \to \mathbb{r}] defined by:
...
Let stem:[\mathcal{V}_h] is the discretized space of the velocity, stem:[\mathcal{P}_h] is the discretized space of the pressure and stem:[\mathcal{T}_h] is the discretized space of the temperature.

We set stem:[N_u = \mathrm{dim} (\mathcal {V}_h)], stem:[N_p = \mathrm{dim} (\mathcal{P}_h)] and stem:[N_T = \mathrm{dim}(\mathcal{T}_h)]. Let stem:[\{ \boldsymbol{\lambda}_i \}_{i = 1, ..., N_u}], stem:[\{ \mu_j \}_{j = 1, ..., N_p}] and stem:[\{ \theta_m \}_{ = 1, ..., N_T}] be the bases of stem:[\mathcal{V}_h], stem:[\mathcal{P}_h] and stem:[\mathcal{T}_h] respectively.

...
The model used is the linear elasticity described in the CSM toolbox, see xref:toolboxes:csm:manual.adoc[Computational Solid Dynamics]
...
----
include::example$spring/spring.json[tags=materials]
----
...
[source,json,indent=0]
----
include::example$spring/spring.json[tags=params]
----
...
[source,json,indent=0]
----
include::example$spring/spring.json[tags=bc]
----
...
[source,json]
----
include::example$spring/spring.json[tags=export]
----
